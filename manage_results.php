    ...
    <div class="main">
        ...
        <form action="" method="post">
            <fieldset>
                ...
                <input type="text" name="rnoo" placeholder="Roll No">
               
                </form>
                <?php 
                  if(isset($_POST['rnoo'])){
                   $rn=$_POST['rnoo'];
                   $q1="SELECT p1,p2,p3,p4,p5 FROM result WHERE rno=$rn";
                ...
                ?>
                <input type="text" name="p1" id="" placeholder="Paper 1 - Marks" value="<?php echo $pe1; ?>">
                <input type="text" name="p2" id="" placeholder="Paper 2 - Marks" value="<?php echo $pe2; ?>">
                <input type="text" name="p3" id="" placeholder="Paper 3 - Marks" value="<?php echo $pe3; ?>">
                <input type="text" name="p4" id="" placeholder="Paper 4 - Marks" value="<?php echo $pe4; ?>">
                <input type="text" name="p5" id="" placeholder="Paper 5 - Marks" value="<?php echo $pe5; ?>">
...
<?php
    ...
    if(isset($_POST['p1'],$_POST['p2'],$_POST['p3'],$_POST['p4'],$_POST['p5'],$_POST['class'])) {
        $rno=$_POST['rnoo'];
